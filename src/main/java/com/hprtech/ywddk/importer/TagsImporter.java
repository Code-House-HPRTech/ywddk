...
public class TagsImporter {
    public static void main(String[] args) throws IOException {
        ...
        File file = new File(typePathMap.get("tags"));
        ...
        try (CSVWriter csvWriter = new CSVWriter(new FileWriter(Constant.typePathMap2.get("tagsCsv")))) {
            // Write header row
        ...
        System.out.println("Conversion successful. CSV file created at: " + Constant.typePathMap2.get("tagsCsv"));
    }
}
